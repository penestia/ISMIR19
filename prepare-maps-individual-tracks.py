...
def main():
    ...
    parser.add_argument('base_dir', help='path to the  folder')
    ...
    train_dir = 'splits/maestro-individual-tracks/train'
    valid_dir = 'splits/maestro-individual-tracks/valid'
    test_dir = 'splits/maestro-individual-tracks/test'
    ...
    with open('splits/maestro-individual-tracks/instruments', 'w') as f:
